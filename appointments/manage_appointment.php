    ...
    <form action="" id="appointment-form">
        ...
        <div class="row">
            <div class="form-group col-md-12">
                ...
                <input type="datetime-local" name="schedule" id="schedule" class="form-control form-control-border" placeholder="Ingresa el horario de la cita" value ="<?php echo isset($schedule) ? date("Y-m-d\TH:i",strtotime($schedule)) : '' ?>" required>
            </div>
        </div>
        <div class="row">
            <div class="form-group col-md-12">
