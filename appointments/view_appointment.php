...
<div class="content py-5">
    <div class="card card-outline card-primary rounded-0 shadow">
        <div class="card-header">
            <h4 class="card-title"><b>Detalles de la cita reservada</b></h4>
            <div class="card-tools">
                <?php if(isset($status) && $status == 0): ?>
                <button class="btn btn-danger bg-gradient-maroon btn-flat btn-sm" type="button" id="cancel_data"> Cancelar Cita</button>
                <?php endif; ?>
...
<script>
    $(function(){
        ...
        $('#cancel_data').click(function(){
			uni_modal("Cancelar cita","appointments/update_status.php?cancel=true&id=<?= isset($id) ? $id : '' ?>",'mid-large')
		})
    })
