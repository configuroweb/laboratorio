...
<div class="card card-outline card-primary rounded-0 shadow">
	<div class="card-header">
		...
		<div class="card-tools">
			<a href="javascript:void(0)" id="create_new" class="btn btn-flat btn-sm btn-primary"><span class="fas fa-plus"></span>  Agregar Nueva Prueba</a>
		</div>
	</div>
	<div class="card-body">
...
<script>
	$(document).ready(function(){
        $('#create_new').click(function(){
			uni_modal("Agregar Nueva Prueba","tests/manage_test.php")
		})
		$('.view_data').click(function(){
			uni_modal("Información de Prueba","tests/view_test.php?id="+$(this).attr('data-id'))
		})
        $('.edit_data').click(function(){
			uni_modal("Actualizar Información de Prueba","tests/manage_test.php?id="+$(this).attr('data-id'))
		})
		$('.delete_data').click(function(){
			_conf("¿Estás segur@ de eliminar esta prueba de forma permanente?","delete_test",[$(this).attr('data-id')])
		})
