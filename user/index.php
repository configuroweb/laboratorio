			...
			<form action="" id="manage-user">	
				...
				<div class="row">
                  <div class="form-group col-md-4">
                      <input type="text" name="firstname" id="firstname" placeholder="Nombre" autofocus required class="form-control form-control-sm form-control-border" value="<?= isset($firstname) ? $firstname :"" ?>">
                  ...
                  <div class="form-group col-md-4">
                      <input type="text" name="lastname" id="lastname" placeholder="Apellido" required class="form-control form-control-sm form-control-border" value="<?= isset($lastname) ? $lastname :"" ?>">
              ...
              <div class="row">
                  ...
                  <div class="form-group col-md-4">
                      <input type="text" name="contact" id="contact" placeholder="+57-3XX-XXXXXXX" required class="form-control form-control-sm form-control-border" value="<?= isset($contact) ? $contact :"" ?>">
              ...
              <div class="row">
                    <div class="form-group col-md-10">
                      <input type="email" name="email" id="email" placeholder="correo@mail.com" required class="form-control form-control-sm form-control-border" value="<?= isset($email) ? $email :"" ?>">
