            ...
            success: function(resp) {
                if (resp) {
                    ...
                    if (resp.status == 'success') {
                        ...
                        var _frm = $('#login-frm')
                        var _msg = "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Tu cuenta aún no ha sido verificada</div>"
                        _frm.prepend(_msg)
                        _frm.find('input').addClass('is-invalid')
                        $('[name="username"]').focus()
                    }
            ...
            success: function(resp) {
                if (resp) {
                    ...
                    if (resp.status == 'success') {
                        ...
                        var _frm = $('#clogin-frm')
                        var _msg = "<div class='alert alert-danger text-white err_msg'><i class='fa fa-exclamation-triangle'></i> Ocurrió un error</div>"
                        _frm.prepend(_msg)
                        _frm.find('input').addClass('is-invalid')
                        $('[name="email"]').focus()
                    }
